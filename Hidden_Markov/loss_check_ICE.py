...
class ICE_Process:
    ...
    def ICE(self, PI, PI_true, gamma_true): # Iterative Channel Estimation Process
        ...
        return PI, train_loss, val_loss, KL_arr
...
f = open('results/' + '%d_%.2f'%(nb_x_classes, assumed_delta) + PI_type + '_' + result_name,'a')
...
Estimated_PI, train_loss, val_loss, KL_arr = ICE_N_DUDE.ICE(assumed_PI, PI, gamma[k+1:n-k+1])
